...
/* harmony default export */ var src_images = (__webpack_require__(315));
...
function (_Onedeck$RootModule) {
  ...
  _createClass(Root, [{
    ...
    value: function init(path) {
      ...
      this.eventHandler(); // this.wnd = new ExampleGlobalWnd();
    ...
    value: function eventHandler() {
      ...
      this.$$on('showGlobalWnd', function () {// this.wnd.show();
      });
      this.$$on('notify', function (text) {// this.notify.notify(text);
      });
    }
  }, {
    key: "dispatcher",
    ...
    key: "exampleAction",
    value: function exampleAction(exampleData) {// webix.confirm({
      //   title: 'EXAMPLE EVENT',
      //   ok: 'Yes',
      //   cancel: 'No',
      //   type: 'confirm-error',
    ...
    key: "ajaxError",
    value: function ajaxError(text) {// webix.confirm({
      //   title: 'SERVER ERROR',
      //   ok: 'Yes',
      //   width: 630,
      //   cancel: 'No',
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __webpack_require__(316)("./".concat(module, "/module"));
...
/******/ });
//# sourceMappingURL=main.ca04cc90df69347aa9c7.js.map